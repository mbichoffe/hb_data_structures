...
def unique_houses(filename):
    ...
    for line in f:
        ...
        #list with information on student, house and cohort

    # Code goes here

    # houses = {house for house in student_info if True}
...
def sort_by_cohort(filename):
    ...
    for line in f:
        ...
        if student_info[4].startswith("G"):
            ghosts.append(student_name)
        elif student_info[4].startswith("W"):
            winter_16.append(student_name)
        elif student_info[4].startswith("Sp"):
            spring_16.append(student_name)
        elif student_info[4].startswith("Su"):
            summer_16.append(student_name)
        elif student_info[4].startswith("F"):
